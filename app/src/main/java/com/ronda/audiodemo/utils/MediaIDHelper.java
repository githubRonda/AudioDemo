...
public class MediaIDHelper {
     ...
     */
    // 把 musicId 和 分类信息 拼接成  <categoryType>/<categoryValue>|<musicUniqueId> 这种形式的 MediaID
     ...
     * @return musicID
     */
    // 从 MediaId 中提取 MusicId. extract 意思就是: 提取,萃取的意思. extra 的意思是: 额外的. 这两个不要弄混淆了
    ...
    public static boolean isMediaItemPlaying(Activity context, MediaBrowserCompat.MediaItem mediaItem) {
        ...
        if (controller != null && controller.getMetadata() != null) {
            // MediaId: <categoryType>/<categoryValue>|<musicUniqueId>
            String currentPlayingMediaId = controller.getMetadata().getDescription().getMediaId();
            KLog.d("currentPlayingMediaId: "+currentPlayingMediaId);
